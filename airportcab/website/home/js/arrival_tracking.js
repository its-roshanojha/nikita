...
function Track_analytics(PNR, Name, Dest, source, STA, STD, mobile, OTP, title) {
    dataJ = {
        "clubMember": [{
            "type": "",
            "type": sessionStorage["MojoboxxURL_booking"] == "Mojoboxx"?"BAC_mojoboxx Analytics":sessionStorage["MojoboxxURL_booking"] == "Facebook"?"Facebook":"Bookairportcab Analytics",
            "user_name": Name,
            ...
            "time": Date.now(),
            "sendLeadSms": "true",
            "title": sessionStorage["MojoboxxURL_booking"] == "Mojoboxx"?"BAC_mojoboxx_arrival":sessionStorage["MojoboxxURL_booking"] == "Facebook"?"BAC_Facebook":title,
            ...
            "OTP": OTP,
            "pnr": PNR,
            "status":  sessionStorage["MojoboxxURL_booking"] == "Mojoboxx"?"BAC_mojoboxx_arrival":sessionStorage["MojoboxxURL_booking"] == "Facebook"?"BAC_Facebook":title,
        }]
    };
...
async function Track_LoadAnalytics(mobile, pageName, title, Name, source_city, citycode, Terminal, Dest_city, source_lat,
  ...
  dataJ = {
          ...
          "pagename": pageName,
          "title": title,
          "type": sessionStorage["MojoboxxURL_booking"] == "Mojoboxx"?"BAC_mojoboxx page load":sessionStorage["MojoboxxURL_booking"] == "Facebook"?"Facebook":"Yatra page load",
          "user_name": Name,
          "last_name": "Customer",
  ...
  $.ajax({
      ...
      // url: 'https://preprodapi.mojoboxx.com/preprod/webapi/cab_analyticsApi'
  });
}