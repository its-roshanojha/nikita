...
let footerData = {
    ...
    socialLinks: [{
            icon: 'https://s3-ap-southeast-1.amazonaws.com/ola-prod-website/insta.svg',
            links: 'https://www.instagram.com/olacabs',
            event: 'desktop_footer_instagram'
        },
        {
            icon: 'https://s3-ap-southeast-1.amazonaws.com/ola-prod-website/youtube.svg',
            links: 'https://www.youtube.com/user/OfficialOlacabs',
            event: 'desktop_footer_youtube'
        },
        {
            icon: 'https://s3-ap-southeast-1.amazonaws.com/ola-prod-website/twitter.svg',
            links: 'https://twitter.com/Olacabs',
            event: 'desktop_footer_twitter'
        }
    ],
    routeColumn1: [{
            label: 'Book a cab',
            links: 'https://book.olacabs.com?utm_source=book_now_top_right',
            event: 'desktop_footer_book_now'
        },
        {
            label: 'Drive with us',
            links: 'https://partners.olacabs.com/',
            event: 'desktop_footer_drive_with_ola'
        },
        {
            label: 'Outstation',
            links: '/outstation',
        ...
        {
            label: 'Ola Money',
            links: 'https://www.olamoney.com',
            event: 'desktop_footer_ola_money'
        },
        {
            label: 'Corporate',
            links: 'https://corporate.olacabs.com',
            event: 'desktop_footer_ola_corporate'
        }
    ],
    routeColumn2: [{
            label: 'About Us',
            links: '/about',
            event: 'desktop_footer_about_us'
        },
        {
            label: 'Contact Us',
            links: '/contact',
            event: 'desktop_footer_contact_us'
        },
        {
            label: 'Support',
            links: 'https://help.olacabs.com/support',
            event: 'desktop_footer_support'
        },
        {
            label: 'Careers',
            links: '/careers',
            event: 'desktop_footer_careers'
        },
        {
            label: 'Media Centre',
            links: 'https://www.olacabs.com/media',
            event: 'desktop_footer_media_centre'
        }
    ],
    routeColumn3: [{
            label: 'Ola S1',
            links: 'https://olaelectric.com/s1?utm_source=Olacabs&utm_medium=CLM&utm_campaign=HHB',
            event: 'desktop_footer_ola_s1'
        },
        {
            label: 'Futurefactory',
            links: 'https://olaelectric.com/future-factory?utm_source=Olacabs&utm_medium=CLM&utm_campaign=HHB',
            event: 'desktop_footer_ola_future_factory'
        },
        {
            label: 'Electric',
            links: 'https://olaelectric.com/?utm_source=Olacabs&utm_medium=CLM&utm_campaign=HHB/',
            event: 'desktop_footer_ola_electric'
        },
        {
            label: 'Investor Relations',
            links: "/investor-relations",
            event: 'desktop_footer_ola_investor_relations'
        },
    ],
    subscribe: {
    ...
    copyright: {
        ...
        internalLinks: [{
                label: 'Notices',
                links: 'https://www.olacabs.com/info/faqs#notices',
                event: 'desktop_footer_notices'
            },
            {
                label: 'Privacy Policy',
                links: 'https://www.olacabs.com/info/faqs#privacyPolicy',
                event: 'desktop_footer_privacy_policy'
            },
            {
                label: 'Terms of Service',
                links: 'https://www.olacabs.com/info/faqs#termsAndConditions',
                event: 'desktop_footer_tncs'
            }
        ],
        externalLinks: [{
                label: 'India',
    ...
    <div class="footerContainer" id="footerContainer">
      <div class="footerTopContainer">
        ...
        <div class="socialContainer">
          <div class="web">
            <img src="./webstatic/img/BAClogo.png" alt="airport cab"/>
          ...
          <div class="routeContainer"><ul>
            ...
            <li><a href="` + footerData.routeColumn3[3].links + `" event-name="` + footerData.routeColumn3[3].event + `" class="event-elem">` + footerData.routeColumn3[3].label + `</a></li>
          </ul></div>
        </div>
      </div>
