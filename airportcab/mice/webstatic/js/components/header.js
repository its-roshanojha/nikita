  ...
  <header class="ola-header-sticky">
    <div id="header" class="secondary-header">
      <div class="max-width">
            ...
            <div class="ola-logo">
              <div class="display-flex">
                <a href="" class="event-elem" event-name="desktop_header_ola_logo">
                  <img src="./webstatic/img/red_box.png" style="width: 46%;
                  float: left;"/>
                </a>
              </div>
            </div>
        ...
        <div>
          <a id="desktop_top_menu_book_now" event-name="desktop_top_menu_book_now" href="#t" class="event-elem book-cab" translation-key="book_ola_cab">Railway</a>
          <a id="desktop_top_menu_free_s1_test_ride_oc_header" event-name="desktop_top_menu_free_s1_test_ride_oc_header" class="event-elem test-ride" href="#" translation-key="free_s1_tr">Hotel</a>
    ...
    <div id="sidebar_nav" class="sidebar_navigation hide-xs">
      ...
      <div class="option-wrapper">
        <ul class="ui-menu-options">
            ...
            <li><a id="desktop_side_nav_ola_krutrim" event-name="desktop_side_nav_ola_krutrim" class="event-elem li-menu-options " href="https://olakrutrim.com/" >Krutrim</a></li>
