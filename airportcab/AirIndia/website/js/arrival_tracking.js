...
function analyticTracking(adid, admenu, adtype) {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: 'https://prodapi.mojoboxx.com/spicescreen/webapi/vuscreen/spicejetTrack'
    });
}
...
function Track_analytics(PNR, Name, Dest, source, STA, STD, mobile, OTP, title) {
    ...
    $.ajax({
        ...
        type: 'POST',
        // url: 'https://prodapi.mojoboxx.com/spicescreen/webapi/departureAnalytics'
        url: 'https://prod.mojoboxx.com/spicescreen/webapi/departureAnalytics'
    });
}


async function Track_LoadAnalytics(mobile, pageName, title, Name, source_city, citycode, Terminal, Dest_city, source_lat, source_long, dest_lat, dest_long, pickup_date, pickuptime) {
  console.log(msgUniqueIdvalue)
  ...
  $.ajax({
      ...
      type: 'POST',
      url: 'https://prodapi.mojoboxx.com/spicescreen/webapi/cab_analyticsApi'
